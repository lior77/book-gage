...
HOSTS = [
    ...
    ("copernicus-dem-30m.s3.amazonaws.com",
     "Copernicus DEM GLO-30 — אריחי הגובה. בלי מפתח ובלי הרשמה"),
    ("www.ipma.pt", "IPMA — נורמלים אקלימיים 1991–2020, דף נתונים לכל תחנה"),
    ("api.ipma.pt", "IPMA/open-data — תחזית ותצפית בלבד. אין בו נורמלים"),
