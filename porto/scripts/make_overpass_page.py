...
QUERIES = [
    {
        "file": "09_freguesia_codes.overpassql",
        "n": "9",
        "title": "הקוד הרשמי של 243 הרובעים",
        "save_as": "freguesia_codes.geojson",
        "colour": "#B3261E",
        "status": "todo",
        "why": "מספרי העיריות באפליקציה הם כבר הקודים הרשמיים (DICOFRE). לרובעים "
               "יש לי קוד רשמי רק ל-7 מתוך 243 — אלה של עיריית פורטו — ולכן המספר "
               "שלהם עדיין מספור פנימי. הקובץ הזה סוגר את זה.",
        "note": "קטנה ומהירה: מבקשת רק גבולות מנהליים ברמה 8 עם התג ref:ine, "
                "ומחזירה נקודה אחת לכל רובע בלי גיאומטריה — הגבולות כבר יש לי מ-CAOP.",
    },
    {
        "file": "07_district_water.overpassql",
        "n": "7",
        "title": "נהרות ומים",
        "save_as": "district_water.geojson",
        "colour": "#1565C0",
        "status": "done",
        "why": "הדואורו, הטמגה, האבה, הסוזה והלסה על כל מפה במפות, עם כפתור כיבוי "
               "והדלקה כמו לשאר השכבות.",
        "note": "השאילתה הראשונה שמחזירה גיאומטריה מלאה (out geom) ולא נקודה אחת "
                "לאובייקט — קו נהר חייב להיות קו. הקובץ יהיה גדול מהקודמים, וזה תקין.",
    },
    {
        "file": "08_district_green.overpassql",
        "n": "8",
        "title": "פארקים, גנים וחופים",
        "save_as": "district_green.geojson",
        "colour": "#2E7D32",
        "status": "done",
        "why": "השטחים הירוקים כפוליגון צבוע ולא כנקודה, כדי שייראו הגודל והצורה.",
        "note": "בכוונה בלי landuse=forest ובלי natural=wood: כל מזרח המחוז מיוער, "
                "ופוליגון שמכסה חצי מפה לא אומר כלום.",
    },
    {
        ...
        "note": "התקבל: 3,575 יישובים, 2,056 מהם בתוך המחוז ו-1,519 נפלו מחוץ לו "
                "(התיבה בולעת שוליים של בראגה ואביירו, והסקריפט מסנן מול CAOP).",
    },
    {
        ...
        "note": "התקבל יחד עם שאילתה 6: 2,297 נקודות, 1,706 מהן בתוך המחוז, "
                "ו-1,530 נכנסו לאפליקציה אחרי ניקוי כפילויות.",
    },
    {
        ...
        "note": "התקבל: 595 אתרים. התנאי — גם name וגם wikidata או heritage — הוא "
                "מה שמנע אלפי רשומות historic שרובן פרט אדריכלי בודד. אף אחד לא בחר ידנית.",
    },
    {
...
<div class="wrap">
  ...
  <p class="lede">שמונה השאילתות שלמטה כבר רצו והקבצים נקלטו — הן נשארות כאן
    לתיעוד. <b>אחת חדשה בראש</b>: הקוד הרשמי של 243 הרובעים, שהוא מה שחסר כדי
    שגם הם יישאו את המספר הרשמי שלהם ולא מספור פנימי.</p>
